...
class consumerAgentDAO:
    ...
    def __init__(self, verbose: bool = True):
        ...
        SYSTEM_MESSAGE = chat_modes["assistant"]["prompt_start"]
        CYPHER_GENERATION_TEMPLATE = chat_modes["assistant"]["agentTools"]["cypher_chain"]
        ...
        #GRAPH #TODO maybe change to config source
        graph = Neo4jGraph(
        ...
        # CYPHER QUERY SEARCH   
        #------------------------------------------------------
        self.cypher_generation_prompt = PromptTemplate.from_template(CYPHER_GENERATION_TEMPLATE["prompt"])
        ...
        self.tools = [
            ...
            Tool.from_function(
                ...
                description=CYPHER_GENERATION_TEMPLATE["description"],
